...
- Try using Troubadour before first hit (during burst so maybe too annoying?)
- Deploy Spreadlo immediately after second hit
 
## Mystery Magic

- Shake After stack/spread
- Fey Illumination as soon as fiary gets back from their break 
...
- Sheet has divide between set 1 and set of tethers to better convey when to use mit
- Spreadlo before KB
- Summon Seraph Added
